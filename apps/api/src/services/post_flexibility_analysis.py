...
class PostFlexibilityAnalysisService:
    ...
    async def pending_flexibility_activities(
        ...
        *,
        ...
        flexibility_rows = [activity for activity in rows if is_flexibility_activity(activity)]
        activity_ids = [activity.id for activity in flexibility_rows]
        ...
        for activity in flexibility_rows:
