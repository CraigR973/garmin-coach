    ...
    data: {
      ...
      rollup: {
        coverage: {
          ...
          sleepMissingDays: 0,
          recoveryDays: 7,
          recoveryMissingDays: 0,
          morningVerdictDays: 7,
          morningVerdictMissingDays: 0,
          thermalNights: 7,
          thermalMissingDays: 0,
          activityCount: 4,
          plannedCount: 5,
          adherenceCapturedCount: 3,
          coverageStatus: 'good',
        },
        sleep: {
          nights: 7,
        ...
        adherence: {
          ...
          sourceState: 'planned_workouts_present',
      ...
      strength: {
        ...
        sessions4w: 6,
        sessionsPerWeek4w: 1.5,
        sessions12w: 18,
        sourceState: 'tracked_strength_activity_present',
        zeroInterpretation: null,
      },
      insights: {
