...
- **2026-07-01** — **Synced today's Garmin ride for Mark + fixed the post-ride analysis gate for outdoor rides (PR #51, squash `4e77f4c`).**
  ...
  via the fixed path (verdict `ready_for_review`, reconciled to the planned Z2). Historical outdoor-ride backfill deliberately not run.
